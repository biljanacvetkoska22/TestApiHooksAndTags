...
namespace UserApi.Tests
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("GetUserFeature", Description="\tIn order to get user information from the API\r\n\tAs an API consumer\r\n\tI want to g" +
        "et users by ID", SourceFile="GetUserFeature.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("Get non-existing user by Id", new string[] {
                "tag1"}, SourceLine=13)]
        public virtual void GetNon_ExistingUserById()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Get non-existing user by Id", new string[] {
                        "tag1"});
#line 14
this.ScenarioSetup(scenarioInfo);
#line 15
